...
const YGLogo = ({ className = "h-12 w-12 flex-shrink-0" }) => (
  <svg width="48" height="48" viewBox="0 0 100 100" className={className} xmlns="http://www.w3.org/2000/svg">
    <rect width="100" height="100" rx="22" fill="#0f172a" stroke="#00ffdc" strokeWidth="6" />
    <text x="50%" y="54%" dominantBaseline="middle" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="52" fontWeight="bold" fill="#00ffdc">YG</text>
  </svg>
);
              ...
              <nav className="container mx-auto flex items-center justify-between flex-wrap pb-0 px-1">
                ...
                <div className="w-full flex items-center justify-between md:hidden">
                  ...
                  <a href="/" onClick={(e) => handleNavClick(e, '#home')} className="flex items-center gap-3">
                    <YGLogo className="h-12 w-12 flex-shrink-0" />
                    <div>
                      <h1 className="font-moderniz text-sm dark:text-[#00ffdc] text-slate-800 whitespace-nowrap">Yash Gaur</h1>
                ...
                <div className="hidden w-full md:grid grid-cols-3 items-center px-8 relative min-h-[48px]">
                  ...
                  >
                    <YGLogo className="h-12 w-12" />
                    <div className="block">
                      <h1 className="font-moderniz text-base dark:text-[#00ffdc] text-slate-800">Yash Gaur</h1>
