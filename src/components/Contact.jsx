  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: <FaGithub />,
      url: 'https://github.com/The-YashGaur',
      color: 'from-gray-800 via-gray-600 to-gray-900',
      hoverColor: 'hover:shadow-gray-500/40 hover:from-gray-700 hover:via-gray-500 hover:to-gray-800'
    },
    {
      name: 'LinkedIn',
      icon: <FaLinkedin />,
      url: '#', // TODO: Add LinkedIn link
      color: 'from-blue-700 via-blue-500 to-blue-800',
      hoverColor: 'hover:shadow-blue-500/40 hover:from-blue-600 hover:via-blue-400 hover:to-blue-700'
    },
    {
      name: 'Codolio',
      icon: <FaCode />,
      url: '#', // TODO: Add Codolio link
      color: 'from-purple-700 via-fuchsia-500 to-purple-900',
      hoverColor: 'hover:shadow-purple-500/40 hover:from-purple-600 hover:via-fuchsia-400 hover:to-purple-800'
    }
  ];
